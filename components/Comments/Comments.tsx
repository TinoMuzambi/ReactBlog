...
import { CommentModel, CommentsProps, UserModel } from "../../interfaces";
...
const Comments: React.FC<CommentsProps> = ({ url }) => {
	...
	const [filteredComments, setFilteredComments] = useState<CommentModel[]>([]);
								...
								<p className="user" onClick={signInWithGoogle}>
									{isSignedIn ? (
										...
										<span
											...
											data-sign-in="Sign in with Google"
										>
								...
								{!isSignedIn && (
									<p className="user" onClick={signInAnon}>
										{isSignedIn ? (
											...
											<span
												className="anon-span"
												data-sign-in="Sign in anonymously"
											>
												<svg
